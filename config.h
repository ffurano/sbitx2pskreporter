...
public:
    ...
    /// @param name The name of the parameter
    /// @param val  The value for the parameter
    void SetString(const char *name, char *val); // legacy function
    ...
    /// Reset array content to empty
    /// @param name The name of the parameter
    void ArrayReset(const char *name);

    /// Add value to array
    /// @param name The name of the parameter
    /// @param val  The value to append in the array
    void ArrayAddString(const char *name, const char *val);
